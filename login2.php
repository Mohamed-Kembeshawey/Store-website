...
<head>
    ...
    <div class="container1">
         <div class="signup-content">
            <form action="login2.php" method="post" name="login" class="signup-form"> 
            <h2 class="form-title"><span class="owner">Vendor</span> Login</h2>
             <img  id="img"src="images/i1.png">
            ...
            <div>
                <button type="submit" name="login_vendor" class="form-submit">Login</button>
            </div>  
